...
static rt_err_t stm32_configure(struct rt_serial_device *serial, struct serial_configure *cfg)
{
    ...
    else if (cfg->baud_rate == BAUD_RATE_500000)
...
#define UART1_TX_EN_PIN     GPIO_Pin_4
#define UART1_TX_EN_GPIO    GPIOE
#define UART1_TX_EN_RCC     RCC_AHB1Periph_GPIOE
...
static void RCC_Configuration(void)
{
	...
	/* Enable UART1 tx enable pin GPIOE4 clocks */
	RCC_AHB1PeriphClockCmd(UART1_TX_EN_RCC, ENABLE);
#endif
...
static void config_uart1_tx_enable_pin()
{
	...
	GPIO_InitStructure.GPIO_Pin = UART1_TX_EN_PIN;
	GPIO_Init(UART1_TX_EN_GPIO, &GPIO_InitStructure);
}
